...
while cap.isOpened():
    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            # Handle pinching
            pinch = is_pinching(hand_landmarks, mp_hands, FRAME_WIDTH, FRAME_HEIGHT)
            ...
            # Draw a circle over the pointer finger tip
    ...
    if (stage == 'pinchStage'):
        ...
        cv2.putText(frame, f"Please pinch and hold directly above the lit LED: {index+1} of {LED_COUNT}", (20, 400), cv2.FONT_HERSHEY_COMPLEX, 0.3, (255, 255, 255), 1, cv2.LINE_AA)
